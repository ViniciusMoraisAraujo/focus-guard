...
// that define the IPC contract (internal/ipc + the referenced domain types:
...
var targets = []target{
	{"internal/policy/policy.go", "policy", "Block", "Block"},
	{"internal/preset/preset.go", "preset", "Preset", "Preset"},
	{"internal/pomodoro/pomodoro.go", "pomodoro", "State", "PomodoroState"},
	{"internal/analytics/analytics.go", "analytics", "DayStat", "DayStat"},
	{"internal/analytics/analytics.go", "analytics", "DomainStat", "DomainStat"},
	{"internal/analytics/analytics.go", "analytics", "Stats", "Stats"},
	{"internal/analytics/analytics.go", "analytics", "LabelStat", "LabelStat"},
	{"internal/analytics/analytics.go", "analytics", "Session", "FocusSession"},
	{"internal/schedule/schedule.go", "schedule", "Rule", "ScheduleRule"},
...
func generate() (string, error) {
	...
	b.WriteString("// Fonte de verdade: os structs Go em internal/ipc e nos pacotes de domínio\n")
