...
var specs = map[string]ActionSpec{
	...
	"metrics":            {Action: "metrics", Permission: PermAuthenticated, Timeout: 5 * time.Second},
	"interceptor-set":    {Action: "interceptor-set", Permission: PermAuthenticated, Timeout: 5 * time.Second},
